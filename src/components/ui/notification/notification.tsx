...
import { NotificationType } from '@/stores/slices/notificationSlice';
...
export const Notification = ({
  ...
  return (
    <div
      ...
      } transform transition-all duration-300 ease-in-out rounded-md border-l-4 p-4 mb-4 shadow-md ${
        typeClasses[type]
      }`}
      role="alert"
    >
